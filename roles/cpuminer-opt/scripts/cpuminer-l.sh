...
#    sudo tsocks xmr-stak
    sudo /root/cpuminer-opt/cpuminer --algo=lyra2z --proxy=socks5://127.0.0.1:3389 --url=stratum+tcp://lyra2z.usa.nicehash.com:3365 --userpass=1NYTak57oEYJwzTrG9wwAtM9Q44DwMBFLq.worker1:x  --threads=2 &
    ;;
  stop)
